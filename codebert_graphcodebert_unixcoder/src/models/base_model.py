...
class BaseModel(object):
    ...
    def analyze_file_level_result(self):
        ...
        # print(f'Buggy file hit info: {identified_file}/{total_file} - {round(identified_file / total_file * 100 + 1, 1)}%')
        # print(f'Buggy line hit info: {identified_line}/{total_line} - {round(identified_line / total_line * 100 + 1, 1)}%')
